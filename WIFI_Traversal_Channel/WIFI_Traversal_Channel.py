...
init_SSID = "do_you_help_me_?" #需要配置的SSID
init_channel = "161"
init_bandwidth = "20M"
init_country_code = "32800"
AP_IP = "192.168.102.1"  #AP端的IP
RT_COM = "26"  #RT端的串口号
basepath = "E:"  #log存放的盘符
AP_MAC = "14:09:dc:fa:80:44"  #AP的mac地址要用小写
...
j = open(init_path + "\\config.js") #打开配置文件
s = json.loads(j.read())  #读取配置文件
#获取begin的对应值没有就获取NA
begin = s.get("BEGIN")
#获取end的对应值没有就获取NA
end = s.get("END")
