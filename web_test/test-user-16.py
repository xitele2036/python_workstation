...
sta_countrys = "AUTO"
powers = "1"
user = ["szhw","lct","dandan","batianhu","tomme","xueshan","jason","xuhao","benren","yucheng","jiali","ouyang","junwen","shengli","xinren","duandi"]
